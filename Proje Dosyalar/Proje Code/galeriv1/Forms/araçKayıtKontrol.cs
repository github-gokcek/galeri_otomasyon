...
{
    public partial class araçKayıtKontrol : UserControl
    {
        public araçKayıtKontrol()
        {
            InitializeComponent();
        }
        ...
        private void basariAnimasyonu()
        {
            new Thread(new ThreadStart(basariAnimasyonuThread)).Start();
        }

        private void basariAnimasyonuThread()
        {
            panelNotification.BackColor = Color.Green;
            Thread.Sleep(3000);
        ...
        private void araçKayıtKontrol_Load(object sender, EventArgs e)
        {
            //YenileListele();
        }
